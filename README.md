...
| **EduMecha** | [🌐](https://samizo-aitl.github.io/EduMecha/) | [💻](https://github.com/Samizo-AITL/EduMecha) | 機械設計・Creo教材（プリントヘッド構造演習対応） | Mechanical design & Creo training (printhead structure exercises) |
| **AITL-H** | [🌐](https://samizo-aitl.github.io/AITL-H/) | [💻](https://github.com/Samizo-AITL/AITL-H) | FSM×PID×LLMによる知能制御（装置制御応用可） | Hybrid intelligent control (equipment control capable) |
