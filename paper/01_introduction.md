...
- **1950年代**: 液滴生成の基礎研究（Continuous Inkjet の原型）  
- **1970年代**: HP, Canon などにより **Thermal Inkjet** が登場  
- **1980年代**: Epson による **Piezo Inkjet** 商用化  
- **1990年代**: 解像度・速度の向上、写真品質プリンタ普及  
- **2000年代**: 産業インクジェットの拡大（電子材料・ディスプレイ）  
- **2010年代**: バイオプリンティング、3D プリントへの応用  
- **2020年代以降**: 半導体製造補助（レジストパターニング、配線形成）、マルチマテリアル印刷、ナノインク技術の研究進展  
